...
def demoData():
    ...
    userActions.newUser('Admin', 1000000, 'password', '61f2fc61fec5b2c7847eaa69368a9e2ee5479f73a8513119476301996ecbc60', 'tag')
    userActions.makeAdmin(1)
    userActions.newUser('Pieter-Tjerk', 1000001, 'password', '7025d4507c74741955afb94b73397eaefff4b4caea8b486169c7be8635917', 'Studenten kaart')
